        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="{{asset('images/users/1.jpg')}}" alt="user-img" class="img-circle"><span class="hide-menu">@if (Auth::user()) {{ Auth::user()->name }} @endif </span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Website</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('bannerList')}}">Banner</a></li>
                                <li><a href="{{route('innovationList')}}">Innovation</a></li>
                                <li><a href="{{route('globalmList')}}">Global</a></li>
