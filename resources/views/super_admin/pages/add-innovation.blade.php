			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-8">
						...
						<h6 class="card-subtitle">Add Innovation Form</h6>
					</div>
					<div class="col-md-4">
						<a href="{{route('innovationList')}}" class="btn btn-info pull-right" style="float:right;"><i class="fa fa-angle-left"></i> Back</a>
					</div>
				</div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="mt-4" action="{{ route('innovationStore') }}" method="POST" enctype="multipart/form-data">
									@csrf
