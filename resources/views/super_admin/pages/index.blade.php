                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    ...
                                                    <div class="d-flex no-block">
                                                        <span><img src="{{asset('images/users/1.jpg')}}" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                ...
                                                <div class="carousel-item">
                                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                                    <div class="d-flex no-block">
                                                        <span><img src="{{asset('images/users/2.jpg')}}" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                                    </span>
                                                ...
                                                <div class="carousel-item">
                                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                                    <div class="d-flex no-block">
                                                        <span><img src="{{asset('images/users/3.jpg')}}" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                                    </span>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="comment-widgets">
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex no-block comment-row border-top">
                                    <div class="p-2"><span class="round"><img src="{{asset('images/users/4.jpg')}}" alt="user" width="50"></span></div>
                                    <div class="comment-text active w-100">
                                ...
                                <div class="to-do-widget m-t-20" id="todo" style="height: 400px;position: relative;">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="{{asset('images/users/1.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="{{asset('images/users/2.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="{{asset('images/users/3.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="{{asset('images/users/4.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="custom-control custom-checkbox">
